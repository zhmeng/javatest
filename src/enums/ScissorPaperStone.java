/**
 * Project Name:java
 * File Name:ScissorPaperStone.java
 * Package Name:enums
 * Date:2014-8-9下午4:17:14
 *
*/
...
/**
 * ClassName:ScissorPaperStone
 * Function: TODO ADD FUNCTION.
 * Date:     2014-8-9 下午4:17:14 
 * @author   张猛
 */
enum HandSign {
    SCISSOR, PAPER, STONE
...
public class ScissorPaperStone {
    public static void main(String[] args){
        ...
        while (!gameOver) {
         ...
         // Print statistics
         System.out.printf("%nNumber of trials: %s  " , numTrials);
